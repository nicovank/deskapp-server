...
public class Delete extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!Residents.delete(id)) {
                throw new TransactionException("There was an error deleting the employee.");
            }

            response.getWriter().println("{}");
            System.out.printf("Resident #'%s' was successfully disabled from the system.%n", id);
